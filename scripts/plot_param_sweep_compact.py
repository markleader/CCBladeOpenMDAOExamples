...
dvs_sf_0 = pd.read_csv('nl_dvs_using_chord_sf_0.0.csv')
dvs_sf_1 = pd.read_csv('nl_dvs_using_chord_sf_1.0.csv')
dvs_sf_2 = pd.read_csv('nl_dvs_using_chord_sf_2.0.csv')
dvs_sf_3 = pd.read_csv('nl_dvs_using_chord_sf_3.0.csv')

forces_sf_0 = pd.read_csv('nl_aero_forces_using_chord_sf_0.0.csv')
forces_sf_1 = pd.read_csv('nl_aero_forces_using_chord_sf_1.0.csv')
forces_sf_2 = pd.read_csv('nl_aero_forces_using_chord_sf_2.0.csv')
forces_sf_3 = pd.read_csv('nl_aero_forces_using_chord_sf_3.0.csv')

stress_sf_0 = pd.read_csv('nl_stress_using_chord_sf_0.0.csv')
stress_sf_1 = pd.read_csv('nl_stress_using_chord_sf_1.0.csv')
stress_sf_2 = pd.read_csv('nl_stress_using_chord_sf_2.0.csv')
stress_sf_3 = pd.read_csv('nl_stress_using_chord_sf_3.0.csv')

disp_sf_0 = pd.read_csv('nl_disp_using_chord_sf_0.0.csv')
disp_sf_1 = pd.read_csv('nl_disp_using_chord_sf_1.0.csv')
disp_sf_2 = pd.read_csv('nl_disp_using_chord_sf_2.0.csv')
disp_sf_3 = pd.read_csv('nl_disp_using_chord_sf_3.0.csv')

# File for use_twist=False, use_RPM=True:
dvs_omega_sf_0 = pd.read_csv('nl_dvs_using_omega_sf_0.0.csv')
dvs_omega_sf_1 = pd.read_csv('nl_dvs_using_omega_sf_1.0.csv')
dvs_omega_sf_2 = pd.read_csv('nl_dvs_using_omega_sf_2.0.csv')
dvs_omega_sf_3 = pd.read_csv('nl_dvs_using_omega_sf_3.0.csv')
dvs_omega_sf_4 = pd.read_csv('nl_dvs_using_omega_sf_4.0.csv')

forces_omega_sf_0 = pd.read_csv('nl_aero_forces_using_omega_sf_0.0.csv')
forces_omega_sf_1 = pd.read_csv('nl_aero_forces_using_omega_sf_1.0.csv')
forces_omega_sf_2 = pd.read_csv('nl_aero_forces_using_omega_sf_2.0.csv')
forces_omega_sf_3 = pd.read_csv('nl_aero_forces_using_omega_sf_3.0.csv')
forces_omega_sf_4 = pd.read_csv('nl_aero_forces_using_omega_sf_4.0.csv')

stress_omega_sf_0 = pd.read_csv('nl_stress_using_omega_sf_0.0.csv')
stress_omega_sf_1 = pd.read_csv('nl_stress_using_omega_sf_1.0.csv')
stress_omega_sf_2 = pd.read_csv('nl_stress_using_omega_sf_2.0.csv')
stress_omega_sf_3 = pd.read_csv('nl_stress_using_omega_sf_3.0.csv')
stress_omega_sf_4 = pd.read_csv('nl_stress_using_omega_sf_4.0.csv')

disp_omega_sf_0 = pd.read_csv('nl_disp_using_omega_sf_0.0.csv')
disp_omega_sf_1 = pd.read_csv('nl_disp_using_omega_sf_1.0.csv')
disp_omega_sf_2 = pd.read_csv('nl_disp_using_omega_sf_2.0.csv')
disp_omega_sf_3 = pd.read_csv('nl_disp_using_omega_sf_3.0.csv')
disp_omega_sf_4 = pd.read_csv('nl_disp_using_omega_sf_4.0.csv')

# File for use_twist=True, use_RPM=False:
dvs_theta_sf_0 = pd.read_csv('nl_dvs_using_theta_sf_0.0.csv')
dvs_theta_sf_1 = pd.read_csv('nl_dvs_using_theta_sf_1.0.csv')
dvs_theta_sf_2 = pd.read_csv('nl_dvs_using_theta_sf_2.0.csv')
dvs_theta_sf_3 = pd.read_csv('nl_dvs_using_theta_sf_3.0.csv')
dvs_theta_sf_4 = pd.read_csv('nl_dvs_using_theta_sf_4.0.csv')

forces_theta_sf_0 = pd.read_csv('nl_aero_forces_using_theta_sf_0.0.csv')
forces_theta_sf_1 = pd.read_csv('nl_aero_forces_using_theta_sf_1.0.csv')
forces_theta_sf_2 = pd.read_csv('nl_aero_forces_using_theta_sf_2.0.csv')
forces_theta_sf_3 = pd.read_csv('nl_aero_forces_using_theta_sf_3.0.csv')
forces_theta_sf_4 = pd.read_csv('nl_aero_forces_using_theta_sf_4.0.csv')

stress_theta_sf_0 = pd.read_csv('nl_stress_using_theta_sf_0.0.csv')
stress_theta_sf_1 = pd.read_csv('nl_stress_using_theta_sf_1.0.csv')
stress_theta_sf_2 = pd.read_csv('nl_stress_using_theta_sf_2.0.csv')
stress_theta_sf_3 = pd.read_csv('nl_stress_using_theta_sf_3.0.csv')
stress_theta_sf_4 = pd.read_csv('nl_stress_using_theta_sf_4.0.csv')

disp_theta_sf_0 = pd.read_csv('nl_disp_using_theta_sf_0.0.csv')
disp_theta_sf_1 = pd.read_csv('nl_disp_using_theta_sf_1.0.csv')
disp_theta_sf_2 = pd.read_csv('nl_disp_using_theta_sf_2.0.csv')
disp_theta_sf_3 = pd.read_csv('nl_disp_using_theta_sf_3.0.csv')
disp_theta_sf_4 = pd.read_csv('nl_disp_using_theta_sf_4.0.csv')

# File for use_twist=True, use_RPM=True:
dvs_theta_omega_sf_0 = pd.read_csv('nl_dvs_using_theta_omega_sf_0.0.csv')
dvs_theta_omega_sf_1 = pd.read_csv('nl_dvs_using_theta_omega_sf_1.0.csv')
dvs_theta_omega_sf_2 = pd.read_csv('nl_dvs_using_theta_omega_sf_2.0.csv')
dvs_theta_omega_sf_3 = pd.read_csv('nl_dvs_using_theta_omega_sf_3.0.csv')
dvs_theta_omega_sf_4 = pd.read_csv('nl_dvs_using_theta_omega_sf_4.0.csv')

forces_theta_omega_sf_0 = pd.read_csv('nl_aero_forces_using_theta_omega_sf_0.0.csv')
forces_theta_omega_sf_1 = pd.read_csv('nl_aero_forces_using_theta_omega_sf_1.0.csv')
forces_theta_omega_sf_2 = pd.read_csv('nl_aero_forces_using_theta_omega_sf_2.0.csv')
forces_theta_omega_sf_3 = pd.read_csv('nl_aero_forces_using_theta_omega_sf_3.0.csv')
forces_theta_omega_sf_4 = pd.read_csv('nl_aero_forces_using_theta_omega_sf_4.0.csv')

stress_theta_omega_sf_0 = pd.read_csv('nl_stress_using_theta_omega_sf_0.0.csv')
stress_theta_omega_sf_1 = pd.read_csv('nl_stress_using_theta_omega_sf_1.0.csv')
stress_theta_omega_sf_2 = pd.read_csv('nl_stress_using_theta_omega_sf_2.0.csv')
stress_theta_omega_sf_3 = pd.read_csv('nl_stress_using_theta_omega_sf_3.0.csv')
stress_theta_omega_sf_4 = pd.read_csv('nl_stress_using_theta_omega_sf_4.0.csv')

disp_theta_omega_sf_0 = pd.read_csv('nl_disp_using_theta_omega_sf_0.0.csv')
disp_theta_omega_sf_1 = pd.read_csv('nl_disp_using_theta_omega_sf_1.0.csv')
disp_theta_omega_sf_2 = pd.read_csv('nl_disp_using_theta_omega_sf_2.0.csv')
disp_theta_omega_sf_3 = pd.read_csv('nl_disp_using_theta_omega_sf_3.0.csv')
disp_theta_omega_sf_4 = pd.read_csv('nl_disp_using_theta_omega_sf_4.0.csv')
...
ax1.plot(xe, dvs_sf_2.chord, color=colors[5], clip_on=False)
ax1.plot(xe, dvs_sf_3.chord, color=colors[7], clip_on=False)
...
ax2.plot(xe, dvs_omega_sf_4.chord, color=colors_rpm[9], clip_on=False)
...
ax3.plot(xe, dvs_sf_2.theta, color=colors[5], clip_on=False)
ax3.plot(xe, dvs_sf_3.theta, color=colors[7], clip_on=False)
...
ax4.plot(xe, dvs_omega_sf_4.theta, color=colors_rpm[9], clip_on=False)
...
ax1.plot(xe, forces_sf_2.Np, color=colors[5], clip_on=False)
ax1.plot(xe, forces_sf_3.Np, color=colors[7], clip_on=False)
...
ax2.plot(xe, forces_omega_sf_4.Np, color=colors_rpm[9], clip_on=False)
...
ax3.plot(xe, forces_sf_2.Tp, color=colors[5], clip_on=False)
ax3.plot(xe, forces_sf_3.Tp, color=colors[7], clip_on=False)
...
ax4.plot(xe, forces_omega_sf_4.Tp, color=colors_rpm[9], clip_on=False)
...
ax1.plot(xe, stress_sf_2.sigma, color=colors[5])
ax1.plot(xe, stress_sf_3.sigma, color=colors[7])
...
ax2.plot(xe, stress_omega_sf_4.sigma, color=colors_rpm[9])
...
ax1.plot(disp_sf_0.x0, (disp_sf_0.u1**2+disp_sf_0.u2**2+disp_sf_0.u3**2)**0.5, color=colors[1], clip_on=False)
ax1.plot(disp_sf_1.x0, (disp_sf_1.u1**2+disp_sf_1.u2**2+disp_sf_1.u3**2)**0.5, color=colors[3], clip_on=False)
ax1.plot(disp_sf_2.x0, (disp_sf_2.u1**2+disp_sf_2.u2**2+disp_sf_2.u3**2)**0.5, color=colors[5], clip_on=False)
ax1.plot(disp_sf_3.x0, (disp_sf_3.u1**2+disp_sf_3.u2**2+disp_sf_3.u3**2)**0.5, color=colors[7], clip_on=False)
...
ax2.plot(disp_omega_sf_0.x0, (disp_omega_sf_0.u1**2+disp_omega_sf_0.u2**2+disp_omega_sf_0.u3**2)**0.5, color=colors_rpm[1], clip_on=False)
ax2.plot(disp_omega_sf_1.x0, (disp_omega_sf_1.u1**2+disp_omega_sf_1.u2**2+disp_omega_sf_1.u3**2)**0.5, color=colors_rpm[3], clip_on=False)
ax2.plot(disp_omega_sf_2.x0, (disp_omega_sf_2.u1**2+disp_omega_sf_2.u2**2+disp_omega_sf_2.u3**2)**0.5, color=colors_rpm[5], clip_on=False)
ax2.plot(disp_omega_sf_3.x0, (disp_omega_sf_3.u1**2+disp_omega_sf_3.u2**2+disp_omega_sf_3.u3**2)**0.5, color=colors_rpm[7], clip_on=False)
ax2.plot(disp_omega_sf_4.x0, (disp_omega_sf_4.u1**2+disp_omega_sf_4.u2**2+disp_omega_sf_4.u3**2)**0.5, color=colors_rpm[9], clip_on=False)
...
ax3.plot(disp_theta_sf_0.x0, (disp_theta_sf_0.u1**2+disp_theta_sf_0.u2**2+disp_theta_sf_0.u3**2)**0.5, color=colors_twist[1], clip_on=False)
ax3.plot(disp_theta_sf_1.x0, (disp_theta_sf_1.u1**2+disp_theta_sf_1.u2**2+disp_theta_sf_1.u3**2)**0.5, color=colors_twist[3], clip_on=False)
ax3.plot(disp_theta_sf_2.x0, (disp_theta_sf_2.u1**2+disp_theta_sf_2.u2**2+disp_theta_sf_2.u3**2)**0.5, color=colors_twist[5], clip_on=False)
ax3.plot(disp_theta_sf_3.x0, (disp_theta_sf_3.u1**2+disp_theta_sf_3.u2**2+disp_theta_sf_3.u3**2)**0.5, color=colors_twist[7], clip_on=False)
ax3.plot(disp_theta_sf_4.x0, (disp_theta_sf_4.u1**2+disp_theta_sf_4.u2**2+disp_theta_sf_4.u3**2)**0.5, color=colors_twist[9], clip_on=False)
...
ax4.plot(disp_theta_omega_sf_0.x0, (disp_theta_omega_sf_0.u1**2+disp_theta_omega_sf_0.u2**2+disp_theta_omega_sf_0.u3**2)**0.5, color=colors_twist_rpm[1], clip_on=False)
ax4.plot(disp_theta_omega_sf_1.x0, (disp_theta_omega_sf_1.u1**2+disp_theta_omega_sf_1.u2**2+disp_theta_omega_sf_1.u3**2)**0.5, color=colors_twist_rpm[3], clip_on=False)
ax4.plot(disp_theta_omega_sf_2.x0, (disp_theta_omega_sf_2.u1**2+disp_theta_omega_sf_2.u2**2+disp_theta_omega_sf_2.u3**2)**0.5, color=colors_twist_rpm[5], clip_on=False)
ax4.plot(disp_theta_omega_sf_3.x0, (disp_theta_omega_sf_3.u1**2+disp_theta_omega_sf_3.u2**2+disp_theta_omega_sf_3.u3**2)**0.5, color=colors_twist_rpm[7], clip_on=False)
ax4.plot(disp_theta_omega_sf_4.x0, (disp_theta_omega_sf_4.u1**2+disp_theta_omega_sf_4.u2**2+disp_theta_omega_sf_4.u3**2)**0.5, color=colors_twist_rpm[9], clip_on=False)
